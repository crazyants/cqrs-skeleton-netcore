...
namespace Uranus.Commercial.Api.Migrations.SecurityDb
{
    [DbContext(typeof(SecurityDbContext))]
    [Migration("20161019011001_securityInitial")]
    partial class securityInitial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Uranus.Commercial.Security.Model.ApplicationRole", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Uranus.Commercial.Security.Model.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Uranus.Commercial.Security.Model.ApplicationRole")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Uranus.Commercial.Security.Model.ApplicationUser")
                        .WithMany("Claims")
